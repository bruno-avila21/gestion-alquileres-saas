...
namespace GestionAlquileres.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909213228_AddSiteSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionAlquileres.Domain.Entities.Contract", b =>
                {
                    ...
                    b.Property<decimal?>("LateFeeDailyRate")
                        ...
                        .HasColumnName("late_fee_daily_rate");
            ...
            modelBuilder.Entity("GestionAlquileres.Domain.Entities.Organization", b =>
                {
                    ...
                    b.Property<string>("PanelPalette")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("panel_palette");
            ...
            modelBuilder.Entity("GestionAlquileres.Domain.Entities.SiteSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("FontPairing")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("font_pairing");

                    b.Property<string>("FooterTagline")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("footer_tagline");
                    ...
                    b.HasIndex("OrganizationId")
                        .IsUnique()
                        .HasDatabaseName("ix_site_settings_organization_id");
            ...
            modelBuilder.Entity("GestionAlquileres.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateOnly?>("AccruedThroughDate")
                        .HasColumnType("date")
                        .HasColumnName("accrued_through_date");
            ...
            modelBuilder.Entity("GestionAlquileres.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("GestionAlquileres.Domain.Entities.Transaction", null)
                        .WithMany()
